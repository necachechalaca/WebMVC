...
namespace webmvc.Areas.Database.Controllers
{
    ...
    public class DbManagerController : Controller
    {
        ...
        {
            _appdbContext.categories.RemoveRange(_appdbContext.categories.Where(c => c.Content.Contains("[fakeData]")));
            ...
            fakerPost.RuleFor(p => p.Descreption, f => f.Lorem.Sentences(3));
